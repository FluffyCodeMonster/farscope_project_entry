...
# height of the shelf within the unit - not including the floor and ceiling of the shelf
shelf_height = 0.36
...
class GripperController:
    ...
    def __init__(self):
        self.pub1 = rospy.Publisher(
            'finger1_controller/command', Float64, queue_size=10)
        self.pub2 = rospy.Publisher(
            'finger2_controller/command', Float64, queue_size=10)
...
class ArmMover:
    ...
    def move(self,
        ...
        wrist_1_cmd = (-1.1)*(shoulder_lift_cmd_in +
                              elbow_cmd_in)  # keep it level
        # wrist_2_cmd = 0.5*pi  # straight along arm
        g = FollowJointTrajectoryGoal()
        g.trajectory = JointTrajectory()
        g.trajectory.joint_names = self.joint_names
        p1 = JointTrajectoryPoint()
        p1.positions = [0.0, shoulder_lift_cmd_in,
                        elbow_cmd_in, wrist_1_cmd, wrist_2_cmd, 0.0]
